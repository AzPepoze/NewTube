...
If you encounter an issue while using NewTube, please report it following these steps:
...
4.   **Provide Details:**
     ...
     -    **Specify Versions:** Mention the version of NewTube and the browser you are using.
