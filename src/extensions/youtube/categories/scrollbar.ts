	...
	settings: [
		{
			...
			value: "thin",
			options: [
				{ label: "Default", value: "auto", enableCss: `* { scrollbar-width: auto !important; }` },
				{ label: "Thin", value: "thin", enableCss: `* { scrollbar-width: thin !important; }` },
				{ label: "Hidden", value: "none", enableCss: `* { scrollbar-width: none !important; }` },
			],
		},
		{
			type: "color",
