 ...
 */
export async function inject_settings_button() {
	const target = await wait_for_element(
...
export function enable_settings_button() {
	window.addEventListener("yt-navigate-finish", inject_settings_button);
	inject_settings_button();
}

export function disable_settings_button() {
	window.removeEventListener("yt-navigate-finish", inject_settings_button);
