...
import { getUserSetting, saveUserSetting } from "@/styleshift/core/storageManager";
import { registerSettingListener, triggerSettingUpdate } from "@/styleshift/settings/functions";
import { getElementIds, createElement, removeElement, getElement, showElement, hideElement } from "./helpers";
import { IModeHandler } from "./types";
import { logger } from "@/shared/logger";
import { createError, createNotification } from "@/styleshift/shared/extension";
import { sleep, waitForElement } from "@/styleshift/shared/normal";
import { updateAllUiComponents } from "@/styleshift/ui/extension";
